  ...
  return (
    <div className={`inline-flex items-center gap-2.5 sm:gap-3 select-none group ${className}`}>
      ...
      >
        ...
        >
          <defs>
            <linearGradient id="bagGradientAdmin" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#ff8c37" />
              <stop offset="50%" stopColor="#f97316" />
              <stop offset="100%" stopColor="#ea580c" />
            </linearGradient>

            <linearGradient id="sparkGradientAdmin" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#ffffff" />
              <stop offset="70%" stopColor="#fed7aa" />
              <stop offset="100%" stopColor="#fdba74" />
            </linearGradient>

            <filter id="sparkGlowAdmin" x="-20%" y="-20%" width="140%" height="140%">
          ...
          <path
            ...
            fill="url(#bagGradientAdmin)"
          />

          {/* Lightning Monogram / S Emblem */}
          <path
            d="M57 43 L40 57 L48.5 57 L43 77 L60 62 L51.5 62 Z"
            fill="url(#sparkGradientAdmin)"
            filter="url(#sparkGlowAdmin)"
          />
        </svg>
