      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ["Frontend", "Modern responsive customer & admin interfaces"],
              ["Backend", "High performance REST API and business logic"],
              ["Database", "Structured MongoDB shop data management"],
              ["Authentication", "Secure role-based authentication and sessions"],
